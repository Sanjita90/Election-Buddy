...
if (isset($_GET['id'])) {
    ...
    echo "<div class='alert alert-danger'>Are you sure you want to delete selected voter? <a href='./delete_voter.php?del_id=$voter_id'>Yes</a> | <a href='./add_voters.php'>No</a></div>";
}
