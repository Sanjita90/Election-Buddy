...
if (isset($_GET['id'])) {
    ...
    echo "<div class='alert alert-danger'>Are you sure you want to delete selected position? <a href='./delete_pos.php?del_id=$pos_id'>Yes</a> | <a href='./add_pos.php'>No</a></div>";
}
