...
if (isset($_GET['id'])) {
    ...
    echo "<div class='alert alert-danger'>Are you sure you want to delete selected organization? <a href='./delete_org.php?del_id=$org_id'>Yes</a> | <a href='./add_org.php'>No</a></div>";
}
