...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Online Voting Sytem</a>
        </div>
...
if (isset($_GET['id'])) {
    ...
    echo "<div class='alert alert-danger'>Are you sure you want to delete selected nominee? <a href='./delete_nominee.php?del_id=$nom_id'>Yes</a> | <a href='./add_nominees.php'>No</a></div>";
}
